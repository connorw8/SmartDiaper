...
export default function App() {
  ...
  // Calibration: Moves the crop box UP to fix the "slightly below" issue
  const Y_CROP_OFFSET = -95;
  ...
  const phTable = [
    {
      ...
      value: 0,
      referenceSquares: [
        { h: 325 }, // Row 0: Dark Magenta
        { h: 35 }, // Row 1: Pale Peach/Orange
        { h: 185 }, // Row 2: Light Cyan
        { h: 75 }, // Row 3: Yellow-Green
      ],
    },
    {
      label: "pH 1",
      value: 1,
      referenceSquares: [
        { h: 350 }, // Row 0: Dark Maroon/Red
        { h: 40 }, // Row 1: Yellow-Orange
        { h: 185 }, // Row 2: Light Cyan
        { h: 75 }, // Row 3: Yellow-Green
      ],
    },
    ...
    },
    {
      ...
      value: 4,
      referenceSquares: [
        { h: 40 }, // Row 0: Yellow-Orange
        { h: 40 }, // Row 1: Pale Yellow-Orange
        { h: 185 }, // Row 2: Light Cyan
        { h: 75 }, // Row 3: Yellow-Green
      ],
    },
    {
      ...
      referenceSquares: [
        { h: 50 }, // Row 0: Yellow
        { h: 45 }, // Row 1: Pale Yellow
        { h: 190 }, // Row 2: Light Cyan/Blue
        { h: 75 }, // Row 3: Yellow-Green
      ],
    },
    {
      ...
      value: 6,
      referenceSquares: [
        { h: 60 }, // Row 0: Greenish-Yellow
        { h: 50 }, // Row 1: Pale Yellow
        { h: 195 }, // Row 2: Light Blue
        { h: 75 }, // Row 3: Yellow-Green
      ],
    },
    {
      ...
      value: 7,
      referenceSquares: [
        { h: 65 }, // Row 0: Olive/Yellow-Green
        { h: 55 }, // Row 1: Pale Tan/Khaki
    ...
    },
    {
      ...
      value: 8,
      referenceSquares: [
        { h: 70 }, // Row 0: Olive/Yellow-Green
        { h: 190 }, // Row 1: Dark Teal/Blue-Green
        { h: 200 }, // Row 2: Light Blue
        { h: 65 }, // Row 3: Olive
      ],
    },
    {
      ...
      referenceSquares: [
        { h: 70 }, // Row 0: Olive
        { h: 220 }, // Row 1: Medium Blue
        { h: 210 }, // Row 2: Light-Medium Blue
        { h: 65 }, // Row 3: Olive
      ],
    },
    {
      ...
      referenceSquares: [
        { h: 70 }, // Row 0: Olive
        { h: 220 }, // Row 1: Medium Blue
        { h: 230 }, // Row 2: Periwinkle/Blue-Purple
    ...
    },
    {
      ...
      referenceSquares: [
        { h: 70 }, // Row 0: Olive
        { h: 220 }, // Row 1: Medium Blue
        { h: 290 }, // Row 2: Dark Purple
        { h: 350 }, // Row 3: Dark Red
      ],
    },
    {
      label: "pH 14",
  ...
  const getPatternMatches = (allSquares) => {
    ...
    const MAX_LIGHTNESS = 70; // Recommended: Increase to 20 to avoid "False Actives" on dry paper
    const UNTOUCHED_PENALTY = 8;

    console.log(`--- Analysis Started (Threshold: ${MAX_LIGHTNESS}%) ---`);
